...
import org.jboss.arquillian.graphene.enricher.SeleniumResourceProvider.LocalStorageProvider;
...
public class TestSeleniumResourceProvider {
    ...
    public void testIndirectProviderCanProvideMethod() {
        ...
        // then
        assertTrue(provider.canProvide(LocalStorage.class));
        assertFalse(provider.canProvide(SessionStorage.class));
    }
    ...
    public void testIndirectProviderLookup() {
        ...
        assertTrue(object instanceof LocalStorage);
